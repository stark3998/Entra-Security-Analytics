...
def _signin_to_dict(r: SignInLog) -> dict:
    return {
        ...
        "risk_event_types": r.risk_event_types,
        "mfa_detail": r.mfa_detail,
        "authentication_details": r.authentication_details,
        "is_interactive": r.is_interactive,
        "client_app_used": r.client_app_used,
        ...
        "applied_ca_policies": r.applied_ca_policies,
...
def _audit_to_dict(r: AuditLog) -> dict:
    return {
        ...
        "logged_by_service": r.logged_by_service,
        "initiated_by_user_id": r.initiated_by_user_id,
        "initiated_by_user": r.initiated_by_user_upn,
        "initiated_by_user_display_name": r.initiated_by_user_display_name,
        "initiated_by_app_id": r.initiated_by_app_id,
...
def _activity_to_dict(r: O365ActivityLog) -> dict:
    return {
        ...
        "source_file_extension": r.source_file_extension,
        "source_relative_url": r.source_relative_url,
        "item_type": r.item_type,
        "target_user_or_group_name": r.target_user_or_group_name,
        "target_user_or_group_type": r.target_user_or_group_type,
        "app_name": r.app_name,
        "environment_name": r.environment_name,
        "extended_properties": r.extended_properties,
        "raw_json": r.raw_json,
    }
